...
import jfleck.gwt.helloserver.client.MyUserCallback;
import jfleck.gwt.helloserver.client.MyUserService;
import jfleck.gwt.helloserver.client.MyUserServiceAsync;
